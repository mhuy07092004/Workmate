/**
 * Post.jsx — Reusable social media post component
 *
 * Displays a post with user info, content, optional image, and interaction buttons.
 * Used in the posts feed throughout the application.
 */
